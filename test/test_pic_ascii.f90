module test_pic_ascii
   ...
   public :: collect_pic_ascii_tests

contains

   !> Collect all exported unit tests
   subroutine collect_pic_ascii_tests(testsuite)
      !> Collection of tests
   ...
   end subroutine collect_pic_ascii_tests
   ...
   subroutine test_is_alphanum_short(error)
      ...
      if (allocated(error)) return
   end subroutine test_is_alphanum_short
   ...
   end subroutine test_is_alphanum_long
   ...
   subroutine test_is_alpha_short(error)
      ...
      if (allocated(error)) return
   end subroutine test_is_alpha_short
   ...
   end subroutine test_is_alpha_long
   ...
   subroutine test_is_lower_short(error)
      ...
      call check(error,.not. is_lower('Á'))
      if (allocated(error)) return
   end subroutine test_is_lower_short
   ...
   end subroutine test_is_lower_long
   ...
   subroutine test_is_upper_short(error)
      ...
      call check(error,.not. is_upper('Á'))
      if (allocated(error)) return
   end subroutine test_is_upper_short
   ...
   end subroutine test_is_upper_long
   ...
   subroutine test_is_digit_short(error)
      ...
      if (allocated(error)) return
   end subroutine test_is_digit_short
   ...
   end subroutine test_is_digit_long
   ...
   subroutine test_is_octal_digit_short(error)
      ...
      if (allocated(error)) return
   end subroutine test_is_octal_digit_short
   ...
   end subroutine test_is_octal_digit_long
   ...
   subroutine test_is_hex_digit_short(error)
      ...
      if (allocated(error)) return
   end subroutine test_is_hex_digit_short
   ...
   end subroutine test_is_hex_digit_long
   ...
   subroutine test_is_white_short(error)
      ...
      if (allocated(error)) return
   end subroutine test_is_white_short
   ...
   end subroutine test_is_white_long
   ...
   subroutine test_is_blank_short(error)
      ...
      if (allocated(error)) return
   end subroutine test_is_blank_short
   ...
   end subroutine test_is_blank_long
   ...
   subroutine test_is_control_short(error)
      ...
      ! print *, .not. is_control('\u2028')
      ! print *, .not. is_control('\u2029')
   end subroutine test_is_control_short
   ...
   end subroutine test_is_control_long
   ...
   end subroutine test_is_punctuation_short
   ...
   end subroutine test_is_punctuation_long
   ...
   subroutine test_is_graphical_short(error)
      ...
      if (allocated(error)) return
   end subroutine test_is_graphical_short
   ...
   end subroutine test_is_graphical_long
   ...
   subroutine test_is_printable_short(error)
      ...
      if (allocated(error)) return
   end subroutine test_is_printable_short
   ...
   end subroutine test_is_printable_long
   ...
   subroutine test_is_ascii_short(error)
      ...
      if (allocated(error)) return
   end subroutine test_is_ascii_short
   ...
   end subroutine test_is_ascii_long
   ...
   subroutine test_to_lower_short(error)
      ...
      if (allocated(error)) return
   end subroutine test_to_lower_short
   ...
   end subroutine test_to_lower_long
   ...
   subroutine test_to_upper_short(error)
      ...
      if (allocated(error)) return
   end subroutine test_to_upper_short
   ...
   end subroutine test_to_upper_long
...
end module test_pic_ascii


program tester_pic_ascii
