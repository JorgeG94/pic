# 1 "/home/runner/work/pic/pic/test/test_pic_string_intrinsic.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
module pic_test_string_intrinsic
   ...
   public :: collect_string_intrinsic_tests

contains

   !> Collect all exported unit tests
   subroutine collect_string_intrinsic_tests(testsuite)
      !> Collection of tests
   ...
   subroutine gen_trim(error, str1, chr1)
      ...
      type(string_type), intent(in) :: str1
      character(len=*), intent(in) :: chr1
      call check(error, slen(trim(str1)) == len(trim(chr1)))
   ...
   subroutine test_trim(error)
      ...
      call check(error, slen(trimmed_str) == 10)
      if (allocated(error)) return
   ...
   subroutine gen_len(error, str1, chr1)
      ...
      type(string_type), intent(in) :: str1
      character(len=*), intent(in) :: chr1
      call check(error, slen(str1) == len(chr1))
